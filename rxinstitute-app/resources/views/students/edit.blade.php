            ...
            <div class="card-body p-4">
                ...
                <form action="{{ url('students/' . $students->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-lg"
                                value="{{ $students->name }}" placeholder="Enter student name" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="address" id="address" class="form-control form-control-lg"
                                value="{{ $students->address }}" placeholder="Enter student address" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="mobile" id="mobile" class="form-control form-control-lg"
                                value="{{ $students->mobile }}" placeholder="Enter student mobile number" required>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ url('students') }}" class="btn btn-outline-secondary px-4 py-2 ms-2">
